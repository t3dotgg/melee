...
/* 2385A0 */ void mnName_802385A0(MnNameData* gobj);
/* 2385D4 */ s32 mnName_GetPageCount(void);
/* 238698 */ s32 mnName_GetColumnCount(void);
/* 238754 */ void mnName_80238754(MnNameData* gobj);
/* 2388D4 */ HSD_JObj* mnName_802388D4(MnNameData* gobj, u8 index);
/* 238964 */ f32 mnName_80238964(u8 index, u8 target, u8 flag);
/* 238A04 */ void mnName_80238A04(MnNameData* gobj, u8 target, u8 flag);
/* 238AE0 */ void mnName_80238AE0(MnNameData* gobj, u8 index, u8 arg2);
/* 238C34 */ void mnName_80238C34(HSD_GObj*, u8, u8);
/* 239574 */ void fn_80239574(HSD_GObj*);
/* 239878 */ void mnName_80239878(u8, MnNameData*);
/* 239A24 */ void mnName_80239A24(MnNameData* gobj);
/* 239EBC */ void mnName_80239EBC(HSD_JObj* jobj, f32 y);
/* 239F5C */ void mnName_80239F5C(HSD_JObj* jobj, f32 x);
/* 239FFC */ void mnName_80239FFC(MnNameData* gobj);
/* 23A058 */ void mnName_8023A058(MnNameData* gobj);
...
/* 23AC40 */ HSD_GObjProc* mnName_8023AC40(void);
