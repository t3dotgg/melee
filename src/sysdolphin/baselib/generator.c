...
/* 4D78F8 */ static uintptr_t hsd_804D78F8;
...
void hsd_8039EE24(u32 mask)
{
    ...
    while (hsd_804D78F4 != 0) {
        ...
        hsd_8039D71C(gp);
        hsd_804D78F4 = (uintptr_t) HSD_SListRemove((HSD_SList*) hsd_804D78F4);
        if (gp->jobj != NULL) {
...
HSD_Generator* hsd_8039F6CC(s32 linkNo, s32 bank, s32 gfx_id, HSD_JObj* jobj)
{
    ...
    gen->type |= (gen->kind & 0x20000) ? 0x500 : 0x700;
    hsd_804D78F4 =
        (uintptr_t) HSD_SListAllocAndAppend((HSD_SList*) hsd_804D78F4, gen);
    return gen;
}
